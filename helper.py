...
#The function bitprod generates an iterable 
#that produces all possible combinations of nbits binary digits (0 and 1).
...
#The function bits2val converts a list of binary digits (0s and 1s) into a decimal integer.
